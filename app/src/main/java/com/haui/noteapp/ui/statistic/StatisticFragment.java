...
//        completedDataSet.setColor(android.graphics.Color.parseColor("#4CAF50")); // Xanh lá
//        completedDataSet.setValueTextSize(14f);
//        completedDataSet.setValueTextColor(android.graphics.Color.BLACK);
//
//        BarDataSet pendingDataSet = new BarDataSet(pendingEntries, "Chưa hoàn thành");
//        pendingDataSet.setColor(android.graphics.Color.parseColor("#FF9800")); // Cam
//        pendingDataSet.setValueTextSize(14f);
//        pendingDataSet.setValueTextColor(android.graphics.Color.BLACK);
//
//        completedDataSet.setValueFormatter(new ValueFormatter() {
//            @Override
//            public String getFormattedValue(float value) {
//                return String.format("%.0f", value);
//            }
//        });
//        pendingDataSet.setValueFormatter(new ValueFormatter() {
//            @Override
//            public String getFormattedValue(float value) {
//                return String.format("%.0f", value);
//            }
